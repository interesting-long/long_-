...
#define ICM20602_SPC_PIN            SPI2_CH3_SCLK_P43                           // 硬件 SPI SCK 引脚
#define ICM20602_SDI_PIN            SPI2_CH3_MOSI_P41                           // 硬件 SPI MOSI 引脚
#define ICM20602_SDO_PIN            SPI2_CH3_MISO_P42                           // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#elif (ICM20602_USE_INTERFACE==SOFT_SPI)
//====================================================软件 SPI 驱动====================================================
	#define ICM20602_SPC_PIN            (P43)                         	 // 软件 SPI SCK  引脚
	#define ICM20602_SDI_PIN            (P41)                         	 // 软件 SPI MOSI 引脚
	#define ICM20602_SDO_PIN            (P42)                         	 // 软件 SPI MISO 引脚
	#define ICM20602_CS_PIN             (P40)                         	 // 软件 SPI CS   引脚
//====================================================软件 SPI 驱动====================================================
#elif (ICM20602_USE_INTERFACE==SOFT_IIC)
//====================================================软件 IIC 驱动====================================================
	#define ICM20602_SOFT_IIC_DELAY     (0)                              // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
	#define ICM20602_SCL_PIN            (IO_P43)                         // 软件 IIC SCL 引脚 连接 MPU6050 的 SCL 引脚
