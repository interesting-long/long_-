...
float Num[Num_Col][Page_Row_Number]={
        {-1  ,1   ,2  ,3  ,4  ,-1 ,30 ,-1 ,-1,620,180,0,250},
        {-1  ,-1  ,0  ,7.2 ,7.2 ,12,230,12 ,-10  ,470 },//GO模式
        {-1  ,-1  ,0  ,6.3  ,6.3,12 ,250,15 ,-10  ,470},//GPO1模式
        {-1  ,-1  ,10  ,6.3 ,6.3 ,12 ,230,15 ,-10  ,470},//GPO2模式
        {-1  ,-1  ,0  ,0 ,0 ,6 ,270,30 ,0  ,60 },//GPO3模式
        {-1  ,-1  ,-1 ,585,-1 ,-1,-1 ,-1 ,-1,-1 },
		{-1  ,20  ,20 ,3  ,-1 ,-1,-1 ,-1 ,-1,-1 },
        {-1  ,1.5   ,30 ,2  ,30 ,0.5 ,10 ,-5 ,20, 300,300},//速度策略参数gpo1
		
		{-1  ,25  ,250 ,13  ,3.5,13 ,3.5 ,-1 ,-1,-1 },//GOpid
		{-1  ,25  ,250 ,13  ,3.5,13 ,3.5 ,-1 ,-1,-1 },//GPO1pid
		{-1  ,27  ,270 ,13  ,3.5,13 ,3.5,-1 ,-1,-1 },//GPO2pid
		{-1  ,0  ,0 ,6  ,1,6 ,1,-1 ,-1,-1 }};//GPO3pid
