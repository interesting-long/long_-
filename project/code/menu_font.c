...
float Num[Num_Col][Page_Row_Number]={
        {-1  ,1   ,2  ,3  ,4  ,-1,1  ,-1 ,-1,80,200},
        {-1  ,28  ,280,32 ,32 ,12 ,310,45 ,0 ,65 },
        {-1  ,30  ,300,35 ,35 ,6 ,320,40 ,0 ,60},
        {-1  ,31  ,310,37 ,37 ,6 ,280,35 ,0 ,60},
        {-1  ,32.5,325,39 ,39 ,6 ,270,30 ,0 ,60 },
        {-1  ,-1  ,-1 ,840,-1 ,-1,-1 ,-1 ,-1,-1 },
		{-1  ,20  ,20 ,3  ,-1 ,-1,-1 ,-1 ,-1,-1 },
        {-1  ,2  ,5 ,4 ,16 ,-20,5 ,15 ,20, }};//数据存储的数组
