...
float Num[Num_Col][Page_Row_Number]={
        ...
        {-1  ,-1  ,0  ,7.4 ,7.4 ,12,250,30 ,0  ,65 },//GO模式
        {-1  ,-1  ,10  ,6  ,6,12 ,245,5 ,0  ,67},//GPO1模式//4环岛
        {-1  ,-1  ,0  ,7 ,7 ,6 ,240,15 ,0  ,67},//GPO2模式
        {-1  ,-1  ,0  ,29 ,29 ,6 ,270,30 ,0  ,60 },//GPO3模式
        {-1  ,-1  ,-1 ,585,-1 ,-1,-1 ,-1 ,-1,-1 },
		{-1  ,20  ,20 ,3  ,-1 ,-1,-1 ,-1 ,-1,-1 },
        {-1  ,1.5   ,20 ,2  ,20 ,0.7 ,8 ,-5 ,20, 40,40},//速度策略参数gpo1
		
		{-1  ,25  ,250 ,13  ,3.5,13 ,3.5 ,-1 ,-1,-1 },//GOpid
		{-1  ,34.5  ,345 ,13  ,3.5,13 ,3.5 ,-1 ,-1,-1 },//GPO1pid
		{-1  ,33  ,330 ,13  ,3.5,13 ,3.5,-1 ,-1,-1 },//GPO2pid
